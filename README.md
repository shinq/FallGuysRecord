...
※2022/12/03 現在の FallGuys 環境ではプレイヤー名が省略されたものしかログ出力されなくなったため、末尾３文字とプラットフォームが同一になる方は同一人物とみなされてしまう状態です。名前をつけられる機能を一応付け足しはしましたが、見にくさの回避にはなってもこの問題は未解決です。集計の信頼性もそれなり、となってしまっておりますので参考情報とお考えいただければ幸いです。
