...
※2022-12-15 現在はプレイヤー名が取得できず、マッチを跨いだ他プレイヤーが同一プレイヤーであるかの判定ができなくなってしまったためいくつかの機能が意味をなさなくなっています。
※自分の戦績と、ラウンド中状況の把握などには今も使えます。
...
* 20221126機能追加：「ラウンド参加者選択」の横には、選択中プレイヤーの名前などをメモできる欄があります。メモに書いた内容はプレイヤー名部分に表示されます。
